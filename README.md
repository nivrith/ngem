...
@polyrithm/ngen/0.0.8 darwin-x64 node-v9.11.1
$ ngen --help [COMMAND]
USAGE
  $ ngen COMMAND
...
...
_See code: [src/commands/generate/interceptor.ts](https://github.com/Polyrithm/ngen/blob/v0.0.8/src/commands/generate/interceptor.ts)_
...
_See code: [src/commands/is-up.ts](https://github.com/Polyrithm/ngen/blob/v0.0.8/src/commands/is-up.ts)_
...
_See code: [src/commands/is/online.ts](https://github.com/Polyrithm/ngen/blob/v0.0.8/src/commands/is/online.ts)_
...
_See code: [src/commands/make/component.ts](https://github.com/Polyrithm/ngen/blob/v0.0.8/src/commands/make/component.ts)_
...
_See code: [src/commands/make/directive.ts](https://github.com/Polyrithm/ngen/blob/v0.0.8/src/commands/make/directive.ts)_
<!-- commandsstop -->
